...
import { Cart, carts, User } from 'src/app/modal/Modal';
...
export class PannierComponent implements OnInit {
  ...
  cartLength = 0;
up:number=0
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,public dialogRef: MatDialogRef<PannierComponent>,private userService: UserService, private route: ActivatedRoute, private dialog: MatDialog,
