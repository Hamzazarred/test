...
@Component({
  selector: 'app-products-c',
  templateUrl: './products-c.component.html',
  styleUrls: ['./products-c.component.scss']
})
export class ProductsCComponent implements OnInit {
  ...
  currentUser:User;
idBoutique:number;
  constructor( private toastr: ToastrService,private orderService: OrderService, private router: Router, private dialog: MatDialog, private route: ActivatedRoute, 
    private token:TokenStorageService, private productService: ProductService,   private cartService: CartService, private userService: UserService) {
...
/********************** */
  ...
  loadProducts() {
    ...
    this.productService.findProductsForCategory(this.idCategory).subscribe(
      (products: any[]) => {
