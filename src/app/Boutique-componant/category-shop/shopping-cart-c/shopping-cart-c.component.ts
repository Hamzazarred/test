...
@Component({
  selector: 'app-shopping-cart-c',
  templateUrl: './shopping-cart-c.component.html',
  styleUrls: ['./shopping-cart-c.component.scss']
})
export class ShoppingCartCComponent implements OnInit {
